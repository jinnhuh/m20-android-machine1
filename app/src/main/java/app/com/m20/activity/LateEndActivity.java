...
public class LateEndActivity extends AppCompatActivity implements View.OnClickListener {
    String TAG_ACTIVITY = "M20_LateEnd";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //사용자 이름 불러 온다
//        int str_name_length = str_name.length();  //이름 길이 저장
        //예약 시간 불러 온다
        prefs =getSharedPreferences("booking_end_time", MODE_PRIVATE);
        String str_time = prefs.getString("end_time", "0"); //키값, 디폴트값
        //예약 시간 불러 온다
